          ...
          <div class="col-lg-3 order-2 order-lg-1">
            ...
            <ul class="list-unstyled small text-muted pl-lg-4 font-weight-normal">
              ...
              foreach ($query as $pro) {
                # code...
              ?>
                <li class="mb-2"><a class="reset-anchor" href="shop.php?id=<?= $pro['id'] ?>"><?= $pro['name'] ?></a></li>
              <?php
              }
          ...
          <div class="col-lg-9 order-1 order-lg-2 mb-5 mb-lg-0">
            ...
            <div class="row">
              ...
              <?php
                    if(isset($_GET['id'])){
                    $id = $_GET['id'];
                    $selectAll ="SELECT * FROM `products` WHERE cat_id = $id" ;
                  }else{
                    $selectAll = "SELECT * FROM `products`";
                  } 
              $queryAll = $connection->query($selectAll);
              foreach ($queryAll as $product) {
                $id = $product['id'];

                $selectImg = "SELECT * FROM `images` WHERE img_id = $id";
                $queryImg = $connection->query($selectImg);
                $resImg = $queryImg->fetch_assoc();
              ?>
                <div class="col-lg-4 col-sm-6">
                  <div class="product text-center">
                    <div class="mb-3 position-relative">
                      ...
                      <a class="d-block" href="detail.php">
                      <img class="img-fluid w-100" src="admin/img/proimage/<?= $resImg['image_name'] ?>" alt="...">
                      </a>
                      <div class="product-overlay">
                        <ul class="mb-0 list-inline">
                          <li class="list-inline-item m-0 p-0"><a class="btn btn-sm btn-outline-dark" href="#"><i class="far fa-heart"></i></a></li>
                          <li class="list-inline-item m-0 p-0"><a class="btn btn-sm btn-dark" href="functions/products/cart.php?id=<?= $product['id']?>">Add to cart</a></li>
                        <a class="btn btn-sm btn-outline-dark" href="#productView" data-toggle="modal"><i class="fas fa-expand"></i></a></li>
                        </ul>
                      </div>
                    </div>
