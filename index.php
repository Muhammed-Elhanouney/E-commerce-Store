  ...
  <div class="container">
    ...
    <section class="pt-5">
      ...
      <div class="row">
        ...
        $selctCat = "SELECT * FROM `categories`";
        $queryCat = $connection->query($selctCat);
        ...
        <div class="col-md-4 mb-4 mb-md-0">
          <a class="category-item mb-4" href="shop.php">
          ...
          <div class="col-xl-3 col-lg-4 col-sm-6">
            <div class="product text-center">
              <div class="position-relative mb-3">
                <div class="badge text-white badge-"></div><a class="d-block" href="detail.php">
